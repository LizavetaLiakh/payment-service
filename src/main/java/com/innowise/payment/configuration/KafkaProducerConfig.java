package com.innowise.payment.configuration;
...
public class KafkaProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, PaymentEventDto> paymentEventProducerFactory() {
    ...
    @Bean(name = "paymentEventKafkaTemplate")
